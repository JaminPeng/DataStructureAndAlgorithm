...
//        boolean[] prefix = new boolean[b.length];
        BM bm = new BM();
//        System.out.println("char array:"+ Arrays.toString(b));
//        System.out.println("suffix:"+ Arrays.toString(suffix));
//        System.out.println("prefix:"+Arrays.toString(prefix));
//        bm.generateGS(b, b.length, suffix, prefix);
//        System.out.println("----------------------------------");
//        System.out.println("suffix:"+Arrays.toString(suffix));
//        System.out.println("prefix:"+Arrays.toString(prefix));

        char[] a = {'a','b','a','b','a','e','a','b','a','c'};
        char[] bb = {'a','b','a','b','a','c','d'};

//        int i = bm.bm_new(a, a.length, bb, bb.length);
//        System.out.println(i);

        bm.kmp(a,a.length,bb, bb.length);
    }
    ...
    public int bm_new(char[] a, int n, char[] b, int m) {
        int[] bc = new int[SIZE]; // 记录模式串中每个字符最后出现的位置
        generateBC(b, m, bc); // 构建坏字符哈希表
